...
import "./bio.css"; // Import the local CSS file
    ...
    <Container>
      ...
      <Row>
        <Col xs={6}>
          ...
          <div
            dangerouslySetInnerHTML={{ __html: bioData.howIUseMyLaptop }}
          ></div>
        </Col>
        <Col xs={6}>
          <h2>How I Use My Phone</h2>
          <div
            dangerouslySetInnerHTML={{ __html: bioData.howIUseMyPhone }}
          ></div>
        </Col>
      </Row>
      <br />
      ...
      <Row>
        <Col>
          ...
          <div
            dangerouslySetInnerHTML={{ __html: bioData.howIThinkAboutTech }}
          ></div>
        </Col>
      </Row>
      <br />
